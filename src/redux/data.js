const projectCard = [
  ...
  },
  {
    ...
    lilDescription: `
      This project is build with an API for any game organization to add their Scores
    ...
    description: `
      This project is build with an API for any game organization to add their Scores
      on the server by the player I know there is an issue anyone could add scores lol,
      but as this project is build for learning API not building the actual prof. leaderboard.<small>
